...
-- Add foreign key for team_invitations
...
ALTER TABLE "maintenance_windows" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP(3);

-- Create indexes for maintenance_windows
